...
public class appAccountMasterScreenUpdateDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAccountChart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    adpTransaction = new ArrayAdapter<>(appAccountMasterScreenUpdateDelete.this, android.R.layout.simple_spinner_item, listTransaction);
                    ...
                    adpCategory = new ArrayAdapter<>(appAccountMasterScreenUpdateDelete.this, android.R.layout.simple_spinner_item, listCategory);
                    ...
                    adpSubCategory = new ArrayAdapter<>(appAccountMasterScreenUpdateDelete.this, android.R.layout.simple_spinner_item, listSubCategory);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(appAccountMasterScreenUpdateDelete.this);
                ...
                builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        boolean returnFirebase = appAccountMasterFirebaseMaintain.appAccountMasterFirebaseDelete();
                        progressBar.setVisibility(View.INVISIBLE);
                        if (returnFirebase) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean returnFirebase = appAccountMasterFirebaseMaintain.appAccountMasterFirebaseUpdate(
                        strTransaction,
                        strCategory,
                        strSubCategory,
                        strName,
