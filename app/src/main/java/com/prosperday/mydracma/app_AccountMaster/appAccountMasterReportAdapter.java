...
public class appAccountMasterReportAdapter extends RecyclerView.Adapter<com.prosperday.mydracma.app_AccountMaster.appAccountMasterReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterFirebaseModel> allListItems;

    public appAccountMasterReportAdapter(Context context, List<appAccountMasterFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public com.prosperday.mydracma.app_AccountMaster.appAccountMasterReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.prosperday.mydracma.app_AccountMaster.appAccountMasterReportAdapter.ViewHolder holder, int position) {
        appAccountMasterFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterScreenUpdateDelete.class);
