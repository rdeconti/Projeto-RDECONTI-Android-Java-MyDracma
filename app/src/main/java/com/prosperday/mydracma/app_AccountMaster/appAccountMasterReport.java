...
public class appAccountMasterReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterFirebaseModel> allListItems;
    private appAccountMasterReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    recyclerViewAdapter = new appAccountMasterReportAdapter(appAccountMasterReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterScreenCreate.class));
            }
        });
    }
