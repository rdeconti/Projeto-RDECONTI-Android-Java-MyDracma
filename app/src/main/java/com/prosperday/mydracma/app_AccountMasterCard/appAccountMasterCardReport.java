...
public class appAccountMasterCardReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterCardFirebaseModel> allListItems;
    private appAccountMasterCardReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterCardFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterCardFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterCardReportAdapter(appAccountMasterCardReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterCardScreenCreate.class));
            }
        });
    }
