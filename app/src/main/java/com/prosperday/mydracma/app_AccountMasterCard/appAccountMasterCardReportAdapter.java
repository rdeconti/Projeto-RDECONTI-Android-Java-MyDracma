...
public class appAccountMasterCardReportAdapter extends RecyclerView.Adapter<appAccountMasterCardReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterCardFirebaseModel> allListItems;

    public appAccountMasterCardReportAdapter(Context context, List<appAccountMasterCardFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterCardReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterCardReportAdapter.ViewHolder holder, int position) {
        appAccountMasterCardFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterCardFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterCardScreenUpdateDelete.class);
