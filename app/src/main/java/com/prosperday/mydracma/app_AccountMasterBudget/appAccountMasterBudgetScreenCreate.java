...
public class appAccountMasterBudgetScreenCreate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_account_master_budget_screen_create);
        ...
        firebaseAccountChart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    adpTransaction = new ArrayAdapter<>(appAccountMasterBudgetScreenCreate.this, android.R.layout.simple_spinner_item, listTransaction);
                    ...
                    adpCategory = new ArrayAdapter<>(appAccountMasterBudgetScreenCreate.this, android.R.layout.simple_spinner_item, listCategory);
                    ...
                    adpSubCategory = new ArrayAdapter<>(appAccountMasterBudgetScreenCreate.this, android.R.layout.simple_spinner_item, listSubCategory);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean returnFirebase = appAccountMasterBudgetFirebaseMaintain.appBudgetFirebaseCreate(
                        strYear,
                        strMonth,
                        strTransaction,
                        strCategory,
    ...
    private void clean_screen_fields() {
        ...
        inputPlanned.setText(null);
        inputRealized.setText(null);
        spnTransaction.setSelection(0);
        spnCategory.setSelection(0);
        spnSubCategory.setSelection(0);
    }
