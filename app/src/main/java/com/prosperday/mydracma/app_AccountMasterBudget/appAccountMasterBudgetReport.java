...
public class appAccountMasterBudgetReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterBudgetFirebaseModel> allListItems;
    private appAccountMasterBudgetReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_account_master_budget_report);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterBudgetFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterBudgetFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterBudgetReportAdapter(appAccountMasterBudgetReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterBudgetScreenCreate.class));
            }
        });
