...
public class appAccountMasterAccountReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterAccountFirebaseModel> allListItems;
    private appAccountMasterAccountReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterAccountFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterAccountFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterAccountReportAdapter(appAccountMasterAccountReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterAccountScreenCreate.class));
            }
        });
    }
