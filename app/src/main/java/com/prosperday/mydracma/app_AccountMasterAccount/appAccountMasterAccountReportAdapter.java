...
public class appAccountMasterAccountReportAdapter extends RecyclerView.Adapter<appAccountMasterAccountReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterAccountFirebaseModel> allListItems;

    public appAccountMasterAccountReportAdapter(Context context, List<appAccountMasterAccountFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterAccountReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterAccountReportAdapter.ViewHolder holder, int position) {
        appAccountMasterAccountFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterAccountFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterAccountScreenUpdateDelete.class);
