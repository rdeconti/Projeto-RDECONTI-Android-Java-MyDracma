...
public class appAccountMasterAssetReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterAssetFirebaseModel> allListItems;
    private appAccountMasterAssetReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterAssetFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterAssetFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterAssetReportAdapter(appAccountMasterAssetReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterAssetScreenCreate.class));
            }
        });
    }
