...
public class appAccountMasterAssetReportAdapter extends RecyclerView.Adapter<appAccountMasterAssetReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterAssetFirebaseModel> allListItems;

    public appAccountMasterAssetReportAdapter(Context context, List<appAccountMasterAssetFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterAssetReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterAssetReportAdapter.ViewHolder holder, int position) {
        appAccountMasterAssetFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterAssetFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterAssetScreenUpdateDelete.class);
