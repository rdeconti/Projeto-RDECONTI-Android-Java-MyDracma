...
public class appAccountMasterInsuranceReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterInsuranceFirebaseModel> allListItems;
    private appAccountMasterInsuranceReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterInsuranceFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterInsuranceFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterInsuranceReportAdapter(appAccountMasterInsuranceReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterInsuranceScreenCreate.class));
            }
        });
    }
