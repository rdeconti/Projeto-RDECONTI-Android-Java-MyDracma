...
public class appAccountMasterInsuranceReportAdapter extends RecyclerView.Adapter<appAccountMasterInsuranceReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterInsuranceFirebaseModel> allListItems;

    public appAccountMasterInsuranceReportAdapter(Context context, List<appAccountMasterInsuranceFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterInsuranceReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterInsuranceReportAdapter.ViewHolder holder, int position) {
        appAccountMasterInsuranceFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterInsuranceFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterInsuranceScreenUpdateDelete.class);
