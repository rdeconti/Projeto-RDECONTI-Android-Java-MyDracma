...
public class appAccountMasterIncomeReportAdapter extends RecyclerView.Adapter<appAccountMasterIncomeReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterIncomeFirebaseModel> allListItems;

    public appAccountMasterIncomeReportAdapter(Context context, List<appAccountMasterIncomeFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterIncomeReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterIncomeReportAdapter.ViewHolder holder, int position) {
        appAccountMasterIncomeFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterIncomeFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterIncomeScreenUpdateDelete.class);
