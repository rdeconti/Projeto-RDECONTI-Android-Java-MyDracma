...
public class appAccountMasterIncomeReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterIncomeFirebaseModel> allListItems;
    private appAccountMasterIncomeReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterIncomeFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterIncomeFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterIncomeReportAdapter(appAccountMasterIncomeReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterIncomeScreenCreate.class));
            }
        });
    }
