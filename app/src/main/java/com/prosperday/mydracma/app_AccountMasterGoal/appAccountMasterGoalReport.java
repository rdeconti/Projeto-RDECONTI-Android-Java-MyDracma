...
public class appAccountMasterGoalReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterGoalFirebaseModel> allListItems;
    private appAccountMasterGoalReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_account_master_goal_report);
        ...
        myDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    appAccountMasterGoalFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterGoalFirebaseModel.class);
                    allListItems.add(snapshotDetails);
                }
                recyclerViewAdapter = new appAccountMasterGoalReportAdapter(appAccountMasterGoalReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterGoalScreenCreate.class));
                finish();
            }
        });
