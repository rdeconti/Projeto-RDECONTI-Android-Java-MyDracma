...
public class appAccountMasterMortageReportAdapter extends RecyclerView.Adapter<appAccountMasterMortageReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterMortageFirebaseModel> allListItems;

    public appAccountMasterMortageReportAdapter(Context context, List<appAccountMasterMortageFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterMortageReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterMortageReportAdapter.ViewHolder holder, int position) {
        appAccountMasterMortageFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterMortageFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterMortageScreenUpdateDelete.class);
