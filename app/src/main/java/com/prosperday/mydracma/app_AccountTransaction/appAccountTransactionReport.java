...
public class appAccountTransactionReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountTransactionFirebaseModel> allListItems;
    private appAccountTransactionReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_account_transaction_report);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountTransactionFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountTransactionFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountTransactionReportAdapter(appAccountTransactionReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountTransactionScreenCreate.class));
            }
        });
    }
