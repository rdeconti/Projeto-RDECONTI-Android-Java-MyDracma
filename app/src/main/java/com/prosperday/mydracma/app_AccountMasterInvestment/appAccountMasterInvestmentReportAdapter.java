...
public class appAccountMasterInvestmentReportAdapter extends RecyclerView.Adapter<appAccountMasterInvestmentReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterInvestmentFirebaseModel> allListItems;

    public appAccountMasterInvestmentReportAdapter(Context context, List<appAccountMasterInvestmentFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterInvestmentReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterInvestmentReportAdapter.ViewHolder holder, int position) {
        appAccountMasterInvestmentFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterInvestmentFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterInvestmentScreenUpdateDelete.class);
