...
public class appAccountMasterInvestmentReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterInvestmentFirebaseModel> allListItems;
    private appAccountMasterInvestmentReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterInvestmentFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterInvestmentFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterInvestmentReportAdapter(appAccountMasterInvestmentReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterInvestmentScreenCreate.class));
            }
        });
    }
