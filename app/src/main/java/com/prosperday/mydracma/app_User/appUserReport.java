...
public class appUserReport extends AppCompatActivity {

    public static Context currentContext;
    List<appUserFirebaseModel> allListItems;
    private appUserReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_user_report);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appUserFirebaseModel snapshotDetails = dataSnapshot.getValue(appUserFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appUserReportAdapter(appUserReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appUserScreenCreate.class));
                finish();
            }
        });
    }
