...
public class appAccountMasterLoanReportAdapter extends RecyclerView.Adapter<appAccountMasterLoanReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterLoanFirebaseModel> allListItems;

    public appAccountMasterLoanReportAdapter(Context context, List<appAccountMasterLoanFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterLoanReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterLoanReportAdapter.ViewHolder holder, int position) {
        appAccountMasterLoanFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterLoanFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterLoanScreenUpdateDelete.class);
