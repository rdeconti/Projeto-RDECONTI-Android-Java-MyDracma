...
public class appAccountMasterLoanReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterLoanFirebaseModel> allListItems;
    private appAccountMasterLoanReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterLoanFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterLoanFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterLoanReportAdapter(appAccountMasterLoanReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterLoanScreenCreate.class));
            }
        });
    }
