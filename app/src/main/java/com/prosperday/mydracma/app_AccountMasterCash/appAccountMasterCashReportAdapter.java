...
public class appAccountMasterCashReportAdapter extends RecyclerView.Adapter<appAccountMasterCashReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterCashFirebaseModel> allListItems;

    public appAccountMasterCashReportAdapter(Context context, List<appAccountMasterCashFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterCashReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterCashReportAdapter.ViewHolder holder, int position) {
        appAccountMasterCashFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterCashFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterCashScreenUpdateDelete.class);
