...
public class appAccountMasterCashReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterCashFirebaseModel> allListItems;
    private appAccountMasterCashReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterCashFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterCashFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterCashReportAdapter(appAccountMasterCashReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterCashScreenCreate.class));
            }
        });
    }
