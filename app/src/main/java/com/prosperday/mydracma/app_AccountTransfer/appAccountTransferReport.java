...
public class appAccountTransferReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountTransferFirebaseModel> allListItems;
    private appAccountTransferReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_account_transfer_report);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountTransferFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountTransferFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountTransferReportAdapter(appAccountTransferReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountTransferScreenCreate.class));
            }
        });
    }
