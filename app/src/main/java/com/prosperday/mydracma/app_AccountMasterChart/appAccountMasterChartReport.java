...
public class appAccountMasterChartReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterChartFirebaseModel> allListItems;
    private appAccountMasterChartReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set Layout */
        setContentView(R.layout.app_account_master_chart_report);
        ...
        /* Set Firebase */
        DatabaseReference myDatabaseReference = FirebaseDatabase.getInstance().getReference("AccountChart");
        ...
        myDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    recyclerViewAdapter = new appAccountMasterChartReportAdapter(appAccountMasterChartReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterChartScreenCreate.class));
            }
        });
    }
