...
public class appAccountMasterOutcomeReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterOutcomeFirebaseModel> allListItems;
    private appAccountMasterOutcomeReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterOutcomeFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterOutcomeFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterOutcomeReportAdapter(appAccountMasterOutcomeReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterOutcomeScreenCreate.class));
            }
        });
    }
