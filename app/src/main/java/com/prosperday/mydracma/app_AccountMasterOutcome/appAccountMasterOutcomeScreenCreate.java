...
public class appAccountMasterOutcomeScreenCreate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAccountChart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    adpTransaction = new ArrayAdapter<>(appAccountMasterOutcomeScreenCreate.this, android.R.layout.simple_spinner_item, listTransaction);
                    ...
                    adpCategory = new ArrayAdapter<>(appAccountMasterOutcomeScreenCreate.this, android.R.layout.simple_spinner_item, listCategory);
                    ...
                    adpSubCategory = new ArrayAdapter<>(appAccountMasterOutcomeScreenCreate.this, android.R.layout.simple_spinner_item, listSubCategory);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean returnFirebase = appAccountMasterOutcomeFirebaseMaintain.appAccountMasterFirebaseCreate(
                        strTransaction,
                        strCategory,
                        strSubCategory,
                        strName,
