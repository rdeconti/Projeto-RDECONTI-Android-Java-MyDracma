...
public class appAccountMasterOutcomeReportAdapter extends RecyclerView.Adapter<appAccountMasterOutcomeReportAdapter.ViewHolder> {

    public static String chooseFromUser;
    private Context context;
    private final List<appAccountMasterOutcomeFirebaseModel> allListItems;

    public appAccountMasterOutcomeReportAdapter(Context context, List<appAccountMasterOutcomeFirebaseModel> TempList) {
    ...
    @NonNull
    @Override
    public appAccountMasterOutcomeReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_account_master_report_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull appAccountMasterOutcomeReportAdapter.ViewHolder holder, int position) {
        appAccountMasterOutcomeFirebaseModel recyclerDetails = allListItems.get(position);
        ...
        public ViewHolder(final View itemView) {
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    appAccountMasterOutcomeFirebaseModel recyclerDetails = allListItems.get(getAdapterPosition());
                    chooseFromUser = recyclerDetails.getAccountMasterKey();
                    Intent intent = new Intent(context, appAccountMasterOutcomeScreenUpdateDelete.class);
