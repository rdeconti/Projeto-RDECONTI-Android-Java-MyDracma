...
public class appAccountMasterCheckScreenUpdateDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAccountChart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    adpTransaction = new ArrayAdapter<>(appAccountMasterCheckScreenUpdateDelete.this, android.R.layout.simple_spinner_item, listTransaction);
                    ...
                    adpCategory = new ArrayAdapter<>(appAccountMasterCheckScreenUpdateDelete.this, android.R.layout.simple_spinner_item, listCategory);
                    ...
                    adpSubCategory = new ArrayAdapter<>(appAccountMasterCheckScreenUpdateDelete.this, android.R.layout.simple_spinner_item, listSubCategory);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(appAccountMasterCheckScreenUpdateDelete.this);
                ...
                builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        boolean returnFirebase = appAccountMasterCheckFirebaseMaintain.appAccountMasterFirebaseDelete();
                        progressBar.setVisibility(View.INVISIBLE);
                        if (returnFirebase) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean returnFirebase = appAccountMasterCheckFirebaseMaintain.appAccountMasterFirebaseUpdate(
                        strTransaction,
                        strCategory,
                        strSubCategory,
                        strName,
