...
public class appAccountMasterCheckReport extends AppCompatActivity {

    public static Context currentContext;
    List<appAccountMasterCheckFirebaseModel> allListItems;
    private appAccountMasterCheckReportAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        appAccountMasterCheckFirebaseModel snapshotDetails = dataSnapshot.getValue(appAccountMasterCheckFirebaseModel.class);
                        allListItems.add(snapshotDetails);
                    }
                    recyclerViewAdapter = new appAccountMasterCheckReportAdapter(appAccountMasterCheckReport.this, allListItems);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), appAccountMasterCheckScreenCreate.class));
            }
        });
    }
